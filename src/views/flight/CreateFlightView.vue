  ...
  <div class="container mx-auto px-4 py-8 max-w-6xl">
    ...
    <form @submit.prevent="handleSubmit" class="space-y-6">
      ...
      <div class="bg-white p-6 rounded-lg shadow">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <select v-model="formData.airlineId" required
          ...
          <div>
            ...
            <select v-model="formData.airplaneId" required :disabled="!formData.airlineId"
          ...
          <div>
            ...
            <input v-model="formData.originAirportCode" type="text" required maxlength="10" placeholder="e.g., CGK, DPS"
              class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500" />
          </div>
          ...
          <div>
            ...
            <input v-model="formData.destinationAirportCode" type="text" required maxlength="10"
      ...
      <div class="bg-white p-6 rounded-lg shadow">
        ...
        <div class="space-y-4">
          <div v-for="(cls, index) in classes" :key="index" class="border border-gray-200 rounded-lg p-4 relative">
            <button v-if="classes.length > 1" type="button" @click="removeClass(index)"
