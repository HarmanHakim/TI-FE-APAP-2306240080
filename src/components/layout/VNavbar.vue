...
<template>
    <header class="fixed top-0 left-0 flex items-center w-full gap-4 px-6 py-4 bg-white shadow-md z-50">
        <RouterLink to="/" class="text-xl font-bold text-blue-600">✈️ Flight Booking</RouterLink>
